...
export async function getSummaryController(req, res) {
    try {
        const result = await getSummaryService(req.allowedDepartmentId);
...
export async function getTrendController(req, res) {
    try {
        const result = await getTrendService(req.allowedDepartmentId, req.query.range);
        return res.status(result.statusCode).json(result);
    } catch (err) {
...
export async function getRecentActivityController(req, res) {
    try {
        const result = await getRecentActivityService(req.allowedDepartmentId);
        return res.status(result.statusCode).json(result);
    } catch (err) {
...
export async function getAnomaliesController(req, res) {
    try {
        const result = await getAnomaliesService(req.allowedDepartmentId);
        return res.status(result.statusCode).json(result);
    } catch (err) {
